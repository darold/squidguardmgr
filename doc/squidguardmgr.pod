...
This interface allows you to define URL rewriting groups, each consists of
...
If you use the SquidClamav Manager GUI it also requires read/write access to the
