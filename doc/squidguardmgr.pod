...
SquidGuard Manager is a Perl CGI Web GUI for squidGuard and SquidClamav administration. It allows full management of SquidGuard blocklist and ACLs. You can also manage graphicaly your SquidClamav configuration.
...
SquidGuard objects (Sources, URL Rewrites, Filters and ACLs).
...
This interface allows you to define as many URL rewriting rules as you want.
They will be applied by SquidGuard following regex pattern matching.

=item Filters

This interface allows you to defined URL destination groups based on predefined
...
This link leads you to the GUI interface to administer SquidClamav configuration
...
This interface allows you to exclude URL or Content-Type from virus scan by
...
quick-restarted. SquidGuard Manager Web GUI does it by using a 'setuid root'ed
wrapper. If your system doesn't support the feature unfortunately, you may need
to do that by hand.

IMPORTANT: SquidGuard Manager doesn't support symbolic links in the SquidGuard
...
to Makefile.PL:
	...
	LANGDIR => Translation language to use (en_US or fr_FR). Default: en_USœ
...
Comma separated list of DNS Blacklists. If you have SquidGuard 1.5 or above put
